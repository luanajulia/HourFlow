...
public class ListarAprovadosAdapter extends BaseAdapter implements Serializable {
    private static final long serialVersionUID = 546546546546L;
    private List<Solicitacao> listarAprovados;
    private Context context;
    private LayoutInflater layout;

    public ListarAprovadosAdapter(List<Solicitacao> listarAprovados, Context context) {
        this.listarAprovados = listarAprovados;
    ...
    @Override
    public int getCount() {
        return listarAprovados.size();
    }

    @Override
    public Object getItem(int i) {
        return listarAprovados.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        Solicitacao sol = listarAprovados.get(i);
        View v = layout.inflate(R.layout.listlayouttempleataprovado, null);
        ...
        MotivoAprovado.setText("Motivo Aprovacao:");
